...
var $author$project$Model$PostIds$decode = A2(
	$elm$json$Json$Decode$map,
	$elm$core$Maybe$andThen($author$project$Model$PostIds$fromList),
...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		...
		if (diffMillis <= 0) {
			...
			var remainingAfterDays = totalSeconds % ((24 * 60) * 60);
			var remainingAfterHours = remainingAfterDays % (60 * 60);
			var seconds = remainingAfterHours % 60;
			var minutes = (remainingAfterHours / 60) | 0;
			var hours = (remainingAfterDays / (60 * 60)) | 0;
			var days = (totalSeconds / ((24 * 60) * 60)) | 0;
			return $elm$core$Maybe$Just(
				A4($author$project$Util$Time$Duration, seconds, minutes, hours, days));
		}
	});
var $author$project$Util$Time$pluralizeDuration = F2(
	function (count, unit) {
		var countStr = $elm$core$String$fromInt(count);
		return (count === 1) ? (countStr + (' ' + unit)) : (countStr + (' ' + (unit + 's')));
	});
var $author$project$Util$Time$addDurationPart = F3(
	function (count, unit, acc) {
		return (count > 0) ? _Utils_ap(
			acc,
			_List_fromArray(
				[
					A2($author$project$Util$Time$pluralizeDuration, count, unit)
				])) : acc;
	});
var $author$project$Util$Time$formatDuration = function (duration) {
	var parts = A3(
		$author$project$Util$Time$addDurationPart,
		duration.seconds,
		'second',
		A3(
			$author$project$Util$Time$addDurationPart,
			...
			A3(
				...
				duration.hours,
				'hour',
				A3($author$project$Util$Time$addDurationPart, duration.days, 'day', _List_Nil))));
	if (!parts.b) {
...
var $author$project$View$Posts$viewUrl = function (maybeUrl) {
	if (maybeUrl.$ === 'Nothing') {
...
var $author$project$View$Posts$postRow = F2(
	function (now, post) {
		var maybeDuration = A2($author$project$Util$Time$durationBetween, post.time, now);
		var timeText = function () {
			if (maybeDuration.$ === 'Just') {
				var duration = maybeDuration.a;
				return A2($author$project$Util$Time$formatTime, $elm$time$Time$utc, post.time) + (' (' + ($author$project$Util$Time$formatDuration(duration) + ')'));
			} else {
				return A2($author$project$Util$Time$formatTime, $elm$time$Time$utc, post.time);
			}
		}();
		return A2(
			$elm$html$Html$tr,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$View$Posts$viewUrl(post.url)
						]))
				]));
	});
...
var $author$project$View$Posts$sortOption = F2(
	function (currentSort, sortBy) {
		return A2(
			$elm$html$Html$option,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$value(
					$author$project$Model$PostsConfig$sortToString(sortBy)),
					$elm$html$Html$Attributes$selected(
					_Utils_eq(currentSort, sortBy))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
									...
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$ChangeSortBy(
											A2(
												...
												$author$project$Model$PostsConfig$sortFromString(val))));
								})
							]),
						A2(
							$elm$core$List$map,
							$author$project$View$Posts$sortOption(config.sortBy),
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\ExampleTests\\CursorTests.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\ExampleTests\\ModelPostIdsTests.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\ExampleTests\\ModelPostsConfigTests.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\ExampleTests\\UtilTimeTests.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\MainTests.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\PostsConfigTests.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\PostsViewTests.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\PostTests.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\SimulatedEffect.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\TestData.elm', 'C:\\Users\\Anda\\Desktop\\Faculta\\An III\\Sem I\\FP\\Project\\Elm-Project\\tests\\TestUtils.elm']),
		processes: 16,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-213696-1";
var net = require('net'),
